...
class MailTemplateServiceTest {
    ...
    void create_savesTemplateWithUpperCaseCode() {
        MailTemplateRequest request = new MailTemplateRequest(
                ...
                "<html>body</html>", "body", true, null, null, null, null, null);
    ...
    void create_defaultsToActive_whenIsActiveNull() {
        MailTemplateRequest request = new MailTemplateRequest(
                "TMPL", "Tmpl", null, "<html/>", "text", null, null, null, null, null, null);
        when(templateRepository.save(any())).thenAnswer(inv -> inv.getArgument(0));
    ...
    void update_modifiesName_andHtmlTemplate() {
        ...
        MailTemplateRequest request = new MailTemplateRequest(
                ...
                "<html>new</html>", "new text", true, null, null, null, null, null);
    ...
    void create_throws_whenHtmlTemplateContainsScript() {
        MailTemplateRequest request = new MailTemplateRequest(
                "BAD", "Bad", null,
                "<html><script>alert(1)</script></html>", "text", true, null, null, null, null, null);
    ...
    void create_throws_whenHtmlTemplateContainsIframe() {
        MailTemplateRequest request = new MailTemplateRequest(
                "BAD", "Bad", null,
                "<html><iframe src='x'></iframe></html>", "text", true, null, null, null, null, null);
    ...
    void create_throws_whenHtmlTemplateContainsJavascriptUri() {
        MailTemplateRequest request = new MailTemplateRequest(
                "BAD", "Bad", null,
                "<a href=\"javascript:void(0)\">click</a>", "text", true, null, null, null, null, null);
    ...
    void update_throws_whenHtmlTemplateContainsScript() {
        MailTemplateRequest request = new MailTemplateRequest(
                ...
                "<script>evil()</script>", "text", true, null, null, null, null, null);
    ...
    void create_accepts_safeHtmlTemplate() {
        MailTemplateRequest request = new MailTemplateRequest(
                "SAFE", "Safe", null,
                "<html><body><p>{replyBody}</p></body></html>", "body", true, null, null, null, null, null);
        when(templateRepository.save(any())).thenAnswer(inv -> inv.getArgument(0));
